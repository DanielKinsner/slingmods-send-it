...
export const VEHICLES: Record<VehicleId, VehicleSpec> = {
  slingshot: {
    ...
    com: [0.15, -0.06],
    inertiaScale: 1.0,
    head: { x: -0.2, y: 0.98, r: 0.2 },
    rear: { x: -1.42, y: -0.18, radius: 0.35, mass: 16 },
    front: { x: 1.38, y: -0.2, radius: 0.31, mass: 20 },
    suspension: { freq: 1.75, damping: 0.42, up: 0.2, down: 0.12 },
    drive: { torque: 820, topSpeed: 24, brake: 760, reverseSpeed: 5, reaction: 0.45 },
    pitch: { air: 2600, airMaxOmega: 5.2, ground: 420 },
    grip: 1.5,
    deck: { x0: -2.05, x1: -0.55, y: 0.42, lip: 0.07 },
    rider: 'seated',
    paint: '#d8242b',
    accent: '#1c1d21',
  },
  ryker: {
    ...
    com: [0.1, -0.04],
    inertiaScale: 0.85,
    head: { x: 0.02, y: 1.2, r: 0.2 },
    rear: { x: -1.14, y: -0.16, radius: 0.33, mass: 14 },
    front: { x: 1.16, y: -0.2, radius: 0.3, mass: 16 },
    suspension: { freq: 1.95, damping: 0.38, up: 0.2, down: 0.13 },
    drive: { torque: 640, topSpeed: 23, brake: 620, reverseSpeed: 5, reaction: 0.5 },
    pitch: { air: 2300, airMaxOmega: 6.2, ground: 380 },
    grip: 1.45,
    deck: { x0: -1.72, x1: -0.5, y: 0.46, lip: 0.07 },
    rider: 'straddle',
    paint: '#f2f2ef',
    accent: '#f0b400',
  },
  spyder: {
    ...
    com: [0.1, -0.08],
    inertiaScale: 1.3,
    head: { x: -0.08, y: 1.2, r: 0.2 },
    rear: { x: -1.45, y: -0.16, radius: 0.35, mass: 18 },
    front: { x: 1.4, y: -0.2, radius: 0.32, mass: 22 },
    suspension: { freq: 1.6, damping: 0.55, up: 0.2, down: 0.12 },
    drive: { torque: 1000, topSpeed: 23, brake: 900, reverseSpeed: 5, reaction: 0.4 },
    pitch: { air: 3000, airMaxOmega: 4.4, ground: 480 },
    grip: 1.55,
    deck: { x0: -2.2, x1: -0.5, y: 0.5, lip: 0.08 },
    rider: 'straddle',
    paint: '#e8e9e6',
    accent: '#2b6fd6',
  },
