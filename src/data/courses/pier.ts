...
export const PIER: CourseSpec = {
  ...
  zones: [
    ...
    { id: 'sb-arcade', kind: 'launch', x0: 304, x1: 307.5, y0: -1, y1: 2.5, bonus: 10 },
    { id: 'sb-gate', kind: 'launch', x0: 14, x1: 17.5, y0: -1, y1: 2.5, bonus: 8 },
    { id: 'sb-gulls', kind: 'launch', x0: 200, x1: 203.5, y0: -1, y1: 2.5, bonus: 11 },
  ...
  decor: [
    ...
    { kind: 'lamp', x: 6 },
    { kind: 'launchpad', x: 14, w: 3.5 },
    { kind: 'launchpad', x: 304, w: 3.5 },
    { kind: 'launchpad', x: 200, w: 3.5 },
    { kind: 'sign', x: 204.5, w: 3.4, h: 1.5, y: 1.4, color: 'yellow', text: 'SEAGULL CATAPULT', small: 'Gulls not included. Ask them.' },
